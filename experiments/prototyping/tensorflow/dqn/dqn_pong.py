...
from experiments.algorithms.common.environment import make_env
from ..common.replay_buffer import ReplayBuffer
from ..common.networks import create_cnn_model
...
class DoubleDQNAgent:
    def __init__(self, env):
        ...
        self.model = create_cnn_model(self.NUM_ACTIONS)
        self.target_model = create_cnn_model(self.NUM_ACTIONS)
